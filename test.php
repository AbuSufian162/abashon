...
$typeErr = $unameErr = $uemailErr = $upassErr = $uphoneErr = $ugenderErr = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (empty($utype) || empty($uname) || empty($uemail) || empty($upassword) || empty($uphone) || empty($ugender)) {
        $typeErr = "All the fields are required";
        ...
        $stmt = $con->prepare("INSERT INTO users (user_type, name, password, gender, contact_no, user_email) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssss", $utype, $uname, $upassword, $ugender, $uphone, $uemail);
...
<tr>
                    ...
                    <td>
                        ...
                        <h2 class="form_boxes"><input type="radio" class="input_text" 
                                name="user" value="Tenant" checked>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
                                type="radio" class="input_text" name="user" value="Owner"></h2>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <h2 class="form_boxes"><input type="radio" class="input_text" placeholder="" name="gender"
                                id="gen" value="Male" checked>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
                                type="radio" class="input_text" placeholder="" name="gender" id="gen" value="Female">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
                                type="radio" class="input_text" placeholder="" name="gender" id="gen" value="Other"></h2>
